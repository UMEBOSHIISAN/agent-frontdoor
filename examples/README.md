...
| [`mothership-task.json`](mothership-task.json) | `.venv/bin/agent-frontdoor validate examples/mothership-task.json` | `VALID demo-review-001`; owner-side Mothership 0.2 conformance input only |
